...
| St | Paper | Year | Link |
|----|-------|------|------|
| ● | Improving Language Understanding by Generative Pre-Training (GPT-1) — Radford et al. ([notes](gpt.md)) | 2018 | [OpenAI PDF](https://cdn.openai.com/research-covers/language-unsupervised/language_understanding_paper.pdf) |
...
| ● | Neural Machine Translation of Rare Words with Subword Units (BPE) — Sennrich et al. ([notes](bpe.md)) | 2015 | [1508.07909](https://arxiv.org/abs/1508.07909) |
